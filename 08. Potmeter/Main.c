///////////////////////////////////////////////////////////////////////////
//  Product/Project : Rotate the potmeters and                           //
///////////////////////////////////////////////////////////////////////////
//
//  File Name    : Main.c
//  Version      : 1.0
//  Description  : Turn the potmeters to display the value on the leds
...
int main(void)
{
    ...
    while (1)
    {
        i = ADC(AD_POT1)+512; 			// +512 signed integer ADC
    	j = ADC(AD_POT2)+512; 			// +512 signed integer ADC
        VU_meter((i*9)>>10,(j*9)>>10);	// Show value on VU leds
    }
    return(0);
}
